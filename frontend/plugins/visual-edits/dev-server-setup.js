      ...
      try {
        ...
        Object.entries(changesByFile).forEach(([fileName, fileChanges]) => {
          ...
          try {
            ...
            execSync(`git -c user.name="visual-edit" -c user.email="edit@tcsvolley.com" add "${targetFile}"`);
            execSync(`git -c user.name="visual-edit" -c user.email="edit@tcsvolley.com" commit -m "visual_edit_${timestamp}"`);
          } catch (gitError) {
